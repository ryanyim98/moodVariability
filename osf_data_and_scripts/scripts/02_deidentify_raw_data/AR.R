# Purpose: lag-1 autoregression (subject-mean-centered, mixed-effects) on PANAS EMA
# sums (AR_PANAS) and on the four task mood-rating blocks (AR_task). Both return a
# list(S = per-subject AR1 coefficient matrix, names, ui = subject ids, L = valid-pair
# counts). Pure in-memory functions, no file I/O. Used by write_anonymized_data.R.
