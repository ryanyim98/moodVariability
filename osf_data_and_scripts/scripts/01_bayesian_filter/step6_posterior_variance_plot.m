% Purpose: figure script -- posterior variance & entropy over time (mean +/- SEM
...
tmp = load(fullfile(anonymized_raw_mat_dir,"Gor_PANAS_Mod_Data_anonymized.mat"), 'Md_Inst_Struct');
