...
```{r}
#mu
mu_retest<- c(cor(df_gor_Est_all$mean_mu_d1r1,df_gor_Est_all$mean_mu_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$mean10_mu_d1r1,df_gor_Est_all$mean10_mu_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$mean5_mu_d1r1,df_gor_Est_all$mean5_mu_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$last_mu_d1r1,df_gor_Est_all$last_mu_d2r1,use = "complete.obs")) %>% 
...
#vmu
vmu_retest<- c(cor(df_gor_Est_all$mean_vmu_d1r1,df_gor_Est_all$mean_vmu_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$mean10_vmu_d1r1,df_gor_Est_all$mean10_vmu_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$mean5_vmu_d1r1,df_gor_Est_all$mean5_vmu_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$last_vmu_d1r1,df_gor_Est_all$last_vmu_d2r1,use = "complete.obs")) %>% 
  cbind(c("all","10_last","5_last","1_last")) %>% 
  as.data.frame()
...
#mu
s_retest<- c(cor(df_gor_Est_all$mean_s_d1r1,df_gor_Est_all$mean_s_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$mean10_s_d1r1,df_gor_Est_all$mean10_s_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$mean5_s_d1r1,df_gor_Est_all$mean5_s_d2r1,use = "complete.obs"),
              cor(df_gor_Est_all$last_s_d1r1,df_gor_Est_all$last_s_d2r1,use = "complete.obs")) %>% 
  cbind(c("all","10_last","5_last","1_last")) %>% 
  as.data.frame()
...
```{r}
#mu
mu_retest<- c(cor(df_gor_Est_wholeday_all$mean_mu_d1,df_gor_Est_wholeday_all$mean_mu_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$mean10_mu_d1,df_gor_Est_wholeday_all$mean10_mu_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$mean5_mu_d1,df_gor_Est_wholeday_all$mean5_mu_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$last_mu_d1,df_gor_Est_wholeday_all$last_mu_d2,use = "complete.obs")) %>% 
  cbind(c("all","10_last","5_last","1_last")) %>% 
  as.data.frame()
names(mu_retest) <- c("value","calc")
mu_retest$calc <- factor(mu_retest$calc, levels = c("all", "10_last", "5_last", "1_last"))
...
#vmu
vmu_retest<- c(cor(df_gor_Est_wholeday_all$mean_vmu_d1,df_gor_Est_wholeday_all$mean_vmu_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$mean10_vmu_d1,df_gor_Est_wholeday_all$mean10_vmu_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$mean5_vmu_d1,df_gor_Est_wholeday_all$mean5_vmu_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$last_vmu_d1,df_gor_Est_wholeday_all$last_vmu_d2,use = "complete.obs")) %>% 
  cbind(c("all","10_last","5_last","1_last")) %>% 
  as.data.frame()
names(vmu_retest) <- c("value","calc")
vmu_retest$calc <- factor(vmu_retest$calc, levels = c("all", "10_last", "5_last", "1_last"))
...
#mu
s_retest<- c(cor(df_gor_Est_wholeday_all$mean_s_d1,df_gor_Est_wholeday_all$mean_s_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$mean10_s_d1,df_gor_Est_wholeday_all$mean10_s_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$mean5_s_d1,df_gor_Est_wholeday_all$mean5_s_d2,use = "complete.obs"),
              cor(df_gor_Est_wholeday_all$last_s_d1,df_gor_Est_wholeday_all$last_s_d2,use = "complete.obs")) %>% 
  cbind(c("all","10_last","5_last","1_last")) %>% 
  as.data.frame()
names(s_retest) <- c("value","calc")
s_retest$calc <- factor(s_retest$calc, levels = c("all", "10_last", "5_last", "1_last"))
...
ggsave("../figures/revision/figure1_wholeday.png",width = 7, height = 3)
```
...
cormat = cor(df_master %>% dplyr::select(mean5_vmu_posminusneg,mean5_s_posminusneg,
                           PANAS_AR1,PANAS_VAR,PANAS_MEAN,
                           mean5_vmu,mean5_s,
                           TASK_AR1,TASK_VAR,TASK_MEAN) %>% 
