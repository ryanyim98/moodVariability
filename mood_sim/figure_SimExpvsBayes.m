...
scatter((ones(9,1)),mean(MuMat_L([7:9,16:18,25:27],:),2))
hold on
scatter(2.*(ones(9,1)),mean(MuMat_L([1:3,10:12,19:21],:),2))
hold on
scatter(3.*(ones(9,1)),mean(MuMat_L([4:6,13:15,22:24],:),2))
...
scatter(ones(9,1),mean(SMat_L([1:9],97:101),2));
 hold on
scatter(2.*(ones(9,1)),mean(SMat_L([10:18],97:101),2));
  hold on
scatter(3.*(ones(9,1)),mean(SMat_L([19:27],97:101),2));
xlim([0.5,3.5])
xticks([1 2 3])
xticklabels({'1','2','3'})
...
scatter((ones(9,1)),mean(VMuMat_L([1,4,7,10,13,16,19,22,25],97:101),2))
hold on
scatter(2.*(ones(9,1)),mean(VMuMat_L([2,5,8,11,14,17,20,23,26],97:101),2))
hold on
scatter(3.*(ones(9,1)),mean(VMuMat_L([(1:9).*3],97:101),2))
xlim([0.5,3.5])
xticks([1 2 3])
